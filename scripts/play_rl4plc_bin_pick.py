...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--task-hint", default=RL4PLC_BIN_PICK_TASK, help="Substring used when searching checkpoint.")
...
def main() -> None:
    ...
    if args.latest:
        checkpoint = str(find_latest_checkpoint(args.logs_root, task_hint=args.task_hint).path)
